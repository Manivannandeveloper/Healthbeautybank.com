...
export interface SectionSliderPostsPropNews {
  className?: string;
  heading: string;
  subHeading?: string;
  posts: PostDataType[];
...
const SectionSliderPostsNew: FC<SectionSliderPostsPropNews> = ({
  heading,
  subHeading,
  className = "",
  posts,
  ...
  return (
    <div className={`nc-SectionSliderPosts $New{className}`}>
...
export default SectionSliderPostsNew;
